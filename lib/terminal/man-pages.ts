...
> = {
  ...
  settings: {
    description: 'List or change portfolio preferences.',
    examples: ['settings list', 'settings set theme dark'],
  },
  theme: { description: 'Choose the terminal colour theme.', examples: ['theme dark', 'theme system'] },
  motion: { description: 'Choose full, reduced or system motion.', examples: ['motion reduced'] },
  sound: { description: 'Turn optional interface sound on or off.', examples: ['sound off'] },
  hints: { description: 'Turn contextual Linux hints on or off.', examples: ['hints on', 'hints off'] },
  search: {
    description: 'Search portfolio content and print insertable paths. Results never open automatically.',
    examples: ['search typescript', 'search portfolio'],
  },
  switch: {
    description: 'List or switch to an operating system.',
    examples: ['switch', 'switch macos', 'switch chooser'],
  },
  tour: { description: 'Start the Linux tour. Suggestions are inserted but never submitted.', examples: ['tour'] },
  legal: { description: 'Read the legal notice in the pager.', examples: ['legal'] },
  plain: { description: 'Print a link to the plain portfolio.', examples: ['plain'] },
  date: { description: 'Print the portfolio date.', examples: ['date'] },
  uname: { description: 'Print PortfolioOS system information.', examples: ['uname', 'uname -a'] },
  hostname: { description: 'Print the host name.', examples: ['hostname'] },
  uptime: { description: 'Print career length as system uptime.', examples: ['uptime'] },
  id: { description: 'Print the active user and groups.', examples: ['id'] },
  finger: { description: "Print Jaswanth's login information and plan.", examples: ['finger', 'finger jaswanth'] },
};
