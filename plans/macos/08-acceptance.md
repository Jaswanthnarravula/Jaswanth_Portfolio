...
| `MAC-PREV-02` | Inline PDF with page-image fallback | P3 | built | `<object type="application/pdf">` with a page-image fallback inside (apps/Preview.tsx); the no-inline-PDF browser case is not asserted |  |
